...
void Metadata::TrackFields::insert(Fields field, const QVariant& value) {
...
QVariant Metadata::TrackFields::get(Fields field) const {
    return data.value(field);
}

bool Metadata::TrackFields::contains(Fields field) const {
